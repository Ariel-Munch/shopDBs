...
public class MailerConfig {
    ...
    private static final String YOUR_GMAIL_ADDRESS = "hapcix@gmail.com";

    /*
    @Bean
    public void testMixedRelatedAlternativeIncludingCalendarAndMessageParsingUsingVariousMailers() throws IOException {
            final String resourcesPathOnDisk = "xXx" ; // determineResourceFolder("simple-java-mail") + "/test/resources";
            ...
            emailPopulatingBuilderNormal.withAttachment("special_????????????ó???????????????Ó?????.txt", "doorcode: Ken sent me".getBytes(defaultCharset()), "text/plain");
